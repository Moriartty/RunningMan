package com.moriarty.user.weather.OtherUserDefind;
...
import com.moriarty.user.weather.DynamicWeather.RefreshDrawable;
import com.moriarty.user.weather.R;
...
//        a.recycle();
        ...
        this.color=a.getColor(R.styleable.PullRefreshLayout_scheme_colors,0xFFFFFFFF);
...
//        mRefreshView.setImageDrawable(mRefreshDrawable);
    	mRefreshDrawable = new SunDrawable(getContext(), this,color);
    	mRefreshView.setImageDrawable(mRefreshDrawable);
    }
