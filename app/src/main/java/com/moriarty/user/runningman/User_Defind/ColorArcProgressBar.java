...
public class ColorArcProgressBar extends View{
    ...
    private int proportion = 5;  //直径占屏幕宽比
    ...
    private float hintSize = 15;
    private float curSpeedSize = 13;
    ...
    private void initCofig(Context context, AttributeSet attrs) {
        ...
        textSize  = a.getInteger(R.styleable.ColorArcProgressBar_text_size,dipToPx(40));
        hintSize = a.getInteger(R.styleable.ColorArcProgressBar_hint_size,15);
        curSpeedSize = a.getInteger(R.styleable.ColorArcProgressBar_title_size,13);
        diameter = a.getInteger(R.styleable.ColorArcProgressBar_diameter,500);
        proportion = a.getInteger(R.styleable.ColorArcProgressBar_proportion,5);
        setCurrentValues(curValues,titleString);
    ...
    private void initView() {
        ...
        diameter = proportion * getScreenWidth() / 10;
        //弧形的矩阵区域
        bgRect = new RectF();
        ...
        //显示单位文字
        hintPaint = new Paint();
        hintPaint.setTextSize(dipToPx(hintSize));
        hintPaint.setColor(Color.parseColor(hintColor));
        hintPaint.setTextAlign(Paint.Align.CENTER);

        //显示标题文字
        curSpeedPaint = new Paint();
        curSpeedPaint.setTextSize(dipToPx(curSpeedSize));
     ...
     * @param currentValues
     */
    public void setCurrentValues(float currentValues,String titleString) {
