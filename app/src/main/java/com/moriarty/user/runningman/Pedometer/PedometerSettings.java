...
public class PedometerSettings {
    ...
    public float getRunStepLength(){
        try{
            return Float.valueOf(mSettings.getString("run_step_length","87.92").trim());
        }catch (NumberFormatException e){
            return 0f;
        }
    }
    public float getRidePadelLength(){
        try{
            return Float.valueOf(mSettings.getString("ride_pedal_length","50").trim());
        }catch (NumberFormatException e){
            return 0f;
        }
    }
    ...
    public void saveServiceRunningWithTimestamp(boolean running) {
        ...
        editor.putLong("last_seen", MainPageFragment.currentTimeInMillis());
        editor.commit();
    }
    ...
    public boolean isNewStart() {
        ...
        return mSettings.getLong("last_seen", 0) < MainPageFragment.currentTimeInMillis() - 1000*60*10;
    }
