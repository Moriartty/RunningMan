...
public class MultiFloatingActionButton extends ViewGroup {
    ...
    private void layoutFloatingActionButton(){
        ...
        switch (mPosition){
            ...
            case POS_RIGHT_BOTTOM:
                fl = getMeasuredWidth() - width - dp2px(30);
    ...
    private void layoutItems(){
        ...
        for(int i=2; i<count; i++) {
            ...
            switch (mPosition) {
                case POS_LEFT_BOTTOM:
                case POS_RIGHT_BOTTOM:
                    cl = getMeasuredWidth() - width - dp2px(30);
    ...
    private void changeBackground(){
        ObjectAnimator animator = isMenuOpen ? ObjectAnimator.ofFloat(mBackgroundView, "alpha", 0.6f, 0f) :
                ObjectAnimator.ofFloat(mBackgroundView, "alpha", 0f, 0.6f);
        animator.setDuration(150);
        animator.setInterpolator(new LinearInterpolator());
        animator.start();
    }
